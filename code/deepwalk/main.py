...
def mode(filepath):
    ...
    parser.add_argument('--format', default='edgelist', help='File format of input file')
    parser.add_argument('--input', nargs='?', default=filepath, help='Input graph file')  
    parser.add_argument('--output', default='../dataset/lastfm_out.txt', help='Output representation file') 
